...
//     <section
//       id="about"
//       className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 relative overflow-hidden scroll-mt-20"
//     >
//       {/* Background decoration */}
...
//                     src={profilePic}
//                     alt="Profile"
//                     className="w-64 h-64 sm:w-56 sm:h-56 md:w-72 md:h-72 object-cover rounded-full"
//                   />
//                   <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 to-transparent rounded-full"></div>
//                 </div>
//               </div>
...
//               <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20">
//                 <p className="text-lg text-gray-700 leading-relaxed mb-6">
//                   Hello! I’m <span className="font-bold">Arushi Singh</span>, pursuing my <span className="font-bold">B.Tech in Computer Science</span> at <em className="italic">Ajay Kumar Garg Engineering College, Ghaziabad</em>.
//                 </p>

//                 <p className="text-lg text-gray-700 leading-relaxed mb-6">
//                   I have a strong foundation in <span className="font-bold">C++</span>, <span className="font-bold">Data Structures & Algorithms</span>, and hands-on experience in <span className="font-bold">frontend web development</span>. With an academic performance of around <span className="font-bold">80%</span> and a <span className="font-bold">certificate for 100% attendance</span>, I value both consistency and dedication.
//                 </p>

//                 <p className="text-lg text-gray-700 leading-relaxed mb-6">
//                   Beyond academics, I was the <span className="font-bold">winner of Volleyball Fit India</span> in college, which strengthened my teamwork and leadership skills.
//                 </p>

//                 <p className="text-lg text-gray-700 leading-relaxed">
//                   I’m passionate about <span className="font-bold">learning new technologies</span>, building real-world projects, and growing as a professional while contributing positively to teams.
//                 </p>
//               </div>
//             </div>
//           </div>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-0 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-16 mb-20">
          ...
          <div className="flex justify-center order-1 lg:order-1">
            <div className="relative w-72 h-72 sm:w-56 sm:h-56 md:w-72 md:h-72">
              <img
                src={profilePic}
                alt="Profile"
          ...
          <div className="space-y-6 order-2 lg:order-2">
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20 text-center lg:text-left">
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Hello! I’m <span className="font-bold">Arushi Singh</span>, pursuing my <span className="font-bold">B.Tech in Computer Science</span> at <em className="italic">Ajay Kumar Garg Engineering College, Ghaziabad</em>.
              </p>
